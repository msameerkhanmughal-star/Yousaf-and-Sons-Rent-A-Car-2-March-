        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button
              ...
              disabled={isLoading}
              className="relative overflow-hidden bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/30 dark:to-red-950/30 border-2 border-primary/30 hover:border-primary text-primary hover:text-primary-dark font-medium h-10 rounded-lg transition-all duration-300 hover:shadow-md hover:shadow-primary/20 hover:-translate-y-0.5 group"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-orange-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
