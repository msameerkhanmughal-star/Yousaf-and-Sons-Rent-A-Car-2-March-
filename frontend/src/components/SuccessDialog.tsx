      ...
      <DialogContent className="sm:max-w-md border-0 bg-transparent shadow-none">
        <div className="relative flex flex-col items-center justify-center p-8">
          ...
          >
            ...
            {/* Title - Orange Color */}
            <h2 
              className={`font-display text-4xl font-black bg-gradient-to-r from-primary via-orange-500 to-orange-600 bg-clip-text text-transparent mb-2 transition-all duration-500 delay-200 ${
